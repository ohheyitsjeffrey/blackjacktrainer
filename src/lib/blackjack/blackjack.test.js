...
// tests that do not call renderer, just test methods on BlackJack instance
// =============================================================================
...
test("incrementBet() Increment Bet When Called", () => {
  ...
  const blackjack = ReactDOM.render(<BlackJack />, div);
...
// tests that call render
// =============================================================================
it("BlackJack Class Renders Without Crashing", () => {
  const div = document.createElement("div");
